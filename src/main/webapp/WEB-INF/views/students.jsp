...
<body>
	...
	<table border="1" align="center">
		<form action="/student/insert"></form>
		<th>학생 등록</th>
		<tr>
		...
		<tr>
			<td align="center"><button>등록하기</button><button type="button" id="cencel">취소하기</button></td>
		</tr>
		</form>
	</table>
	
	<script>
		document.getElementById("cencel").onclick = fuction(){
			location.href = "/";
		}
	</script>
